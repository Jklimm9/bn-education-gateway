...
const About = () => {
  const advantages = ["Персональний графік навчання", "Постійний супровід менеджера", "Звітність та фідбек викладачів", "Детальні програми підготовки", "Моніторинг результатів", "Гнучкий розклад занять"];
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="animate-fade-in">
            <h3 className="font-playfair text-3xl font-semibold text-burgundy-700 mb-6">Центр підготовки - це...</h3>
            <p className="text-lg text-burgundy-600 mb-8 leading-relaxed"></p>

            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {advantages.map((advantage, index) => <div key={index} className="flex items-center space-x-3">
